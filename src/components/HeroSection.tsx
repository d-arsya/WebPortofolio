    ...
    <section className="min-h-screen flex items-center justify-center px-4 pt-18 md:pt-1 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto text-center">
        <div className="mb-8">
          ...
          <div className="text-2xl md:text-3xl text-blue-600 dark:text-blue-400 font-semibold mb-6">
        ...
        <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
          Software Engineering student at Universitas Gadjah Mada specializing
          in backend development with Laravel, NestJS, and FastAPI. Passionate
          about building scalable systems and leading technical teams to create
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-12">
          ...
          <a
            ...
            download
            className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-2 border-gray-300 dark:border-gray-700 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Download CV
          </a>
        </div>
